            ...
            <div className="absolute left-6 top-1/2 flex -translate-y-1/2 items-center gap-2">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="flex items-center gap-2 rounded-xl border border-[#3453a7] bg-[#3453a7] px-5 py-2.5 text-sm font-semibold text-white shadow-none hover:bg-[#28448e] hover:text-white">
            ...
            {isLoadingData ? (
              ...
              <div className="space-y-3">
                {teachers.map((teacher) => (
                  <div
                    key={teacher.id}
                    className="flex items-center justify-between rounded-xl border border-[#3453a7]/20 bg-white p-4 transition-colors hover:border-[#3453a7]/50"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex items-center gap-2 text-xs text-neutral-500">
                          <span className="rounded-full bg-[#3453a7]/10 px-2 py-0.5 text-[#3453a7]">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        className="h-8 border-[#3453a7]/30 text-[#3453a7] hover:bg-[#3453a7]/10"
                      >
      ...
      >
        ...
        >
          <DialogHeader className="border-b border-[#3453a7]/30 bg-gradient-to-r from-[#3453a7]/8 to-transparent px-6 py-5">
            ...
            {addDialogView === "bulk" ? (
              <DialogDescription className="sr-only">إضافة جماعية للمعلمين عبر الإدخال اليدوي أو ملف إكسل.</DialogDescription>
            ) : null}
          </DialogHeader>
            ...
            <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      className="h-10 rounded-xl border-[#3453a7]/40 text-sm focus-visible:border-[#3453a7] focus-visible:ring-[#3453a7]/30"
                    />
                  </div>
                  <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <Select value={selectedHalaqah} onValueChange={setSelectedHalaqah}>
                      <SelectTrigger className="h-10 rounded-xl border-[#3453a7]/40 text-sm focus:border-[#3453a7]">
              ...
              <div className="flex gap-3 border-t border-[#3453a7]/25 px-6 py-4">
                <Button
                  ...
                  className="h-10 flex-1 rounded-lg border-none bg-[#3453a7] text-white transition-colors hover:bg-[#24428f] disabled:cursor-not-allowed disabled:bg-[#8ea2df] disabled:text-white disabled:opacity-100"
                >
                ...
                <Button
                  ...
                  className="h-10 rounded-xl border-[#3453a7]/40 text-neutral-600"
                >
                  إلغاء
                </Button>
              </div>
              ...
              <div className="space-y-4 overflow-y-auto px-6 py-5">
                <div className="rounded-2xl border border-[#3453a7]/20 bg-[#fafcff] p-4">
                  <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    ...
                    <label className="inline-flex w-fit cursor-pointer items-center gap-2 rounded-xl border border-[#3453a7]/40 bg-white px-4 py-2 text-sm font-semibold text-[#4f73d1] transition-colors hover:bg-[#3453a7]/10">
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-sm font-medium text-[#4f73d1] transition-colors hover:text-[#3453a7]"
                >
        ...
        <DialogContent className="sm:max-w-[480px]" dir="rtl" style={{ zIndex: 110 }}>
          ...
          <div className="flex justify-end gap-3" dir="rtl">
            ...
            <Button
              ...
              className="border-none bg-[#3453a7] text-white hover:bg-[#24428f] disabled:bg-[#8ea2df] disabled:text-white disabled:opacity-100"
            >
