      ...
      <div className="container relative mx-auto">
        <div className="mx-auto flex min-h-[calc(100vh-7rem)] max-w-6xl flex-col items-center justify-center gap-4 py-16 sm:py-20 lg:gap-6 lg:py-24">
          <div className="flex flex-col items-center text-center">
            <h1 className="max-w-5xl pb-3 bg-[linear-gradient(135deg,#20335f_0%,#3453a7_58%,#7d9ff5_100%)] bg-clip-text text-balance text-5xl font-black leading-[1.18] tracking-tight text-transparent sm:text-6xl lg:text-8xl">
            ...
            <p className="mt-4 max-w-4xl text-lg leading-9 text-[#4b5563] sm:mt-5 sm:text-2xl sm:leading-10 lg:text-3xl lg:leading-[1.9]">
